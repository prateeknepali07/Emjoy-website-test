...
import BookingRequest from "./components/Tenant/BookingRequest";
import Invoices from "./components/Tenant/Invoices";
import MaintenanceTickets from "./components/Tenant/MaintenanceTickets";
import Payments from "./components/Tenant/Payments";
import Tenantlist from "./components/Tenant/Tenantlist";
import VisitRequest from "./components/Tenant/VisitRequest";

import OwnerPayments from "./components/Owner/Payments";
import OwnerInvoices from "./components/Owner/Invoices";
...
import BeatO1 from "./components/BeatO/BeatO1";
import BeatO2 from "./components/BeatO/BeatO2";
import BeatO3 from "./components/BeatO/BeatO3";
          ...
          >
            <div>
              <Switch location={location}>
                ...
                />
                <Route path="/Tenant-Invoices" component={Invoices} />
                <Route
                  path="/Tenant-MaintenanceTickets"
                  component={MaintenanceTickets}
                />
                <Route path="/Tenant-Payments" component={Payments} />
                <Route path="/Tenant-Tenantlist" component={Tenantlist} />
                <Route path="/Tenant-VisitRequest" component={VisitRequest} />
                {/*Owner*/}
                <Route path="/Owner-invoices" component={OwnerInvoices} />
                <Route path="/Owner-ownerlist" component={Ownerlist} />
                <Route path="/Owner-ownerPayments" component={OwnerPayments} />
                <Route
                  path="/Owner-propertylistrequest"
                  component={Propertylistrequest}
                />
                {/*Property*/}
